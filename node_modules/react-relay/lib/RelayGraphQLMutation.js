...
var PendingGraphQLTransaction = function () {
  ...
  PendingGraphQLTransaction.prototype.getOptimisticResponse = function getOptimisticResponse() {
    return (0, _extends5['default'])({}, this._optimisticResponse, (0, _defineProperty3['default'])({}, require('relay-runtime').ConnectionInterface.get().CLIENT_MUTATION_ID, this.id));
  };
  ...
  PendingGraphQLTransaction.prototype._getVariables = function _getVariables() {
    ...
    return (0, _extends5['default'])({}, this._variables, {
      input: (0, _extends5['default'])({}, input, (0, _defineProperty3['default'])({}, require('relay-runtime').ConnectionInterface.get().CLIENT_MUTATION_ID, this.id))
    });
  };
