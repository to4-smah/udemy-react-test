...
var RelayQueryWriter = function (_RelayQueryVisitor) {
  ...
  RelayQueryWriter.prototype._writeEdges = function _writeEdges(connection, edges, state) {
    ...
    edgesData.forEach(function (edgeData) {
      ...
      var nodeID = nodeData && nodeData[require('./RelayNodeInterface').ID] || prevEdge && _this4._store.getLinkedRecordID(prevEdge.edgeID, NODE) || require('./generateClientID')();
  ...
  RelayQueryWriter.prototype._writeLink = function _writeLink(field, state, recordID, fieldData) {
    ...
    var nextLinkedID = field.getSchemaName() === NODE && nodeID || fieldData[require('./RelayNodeInterface').ID] || prevLinkedID || require('./generateClientID')();
