...
function createContainerComponent(Component, spec) {
  ...
  var RelayContainer = function (_React$Component) {
    ...
    function RelayContainer(props, context) {
      ...
      !require('./isClassicRelayContext')(relay) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayContainer: `%s` was rendered with invalid Relay context `%s`. ' + 'Make sure the `relay` property on the React context conforms to the ' + '`RelayEnvironment` interface.', containerName, relay) : require('fbjs/lib/invariant')(false) : void 0;
